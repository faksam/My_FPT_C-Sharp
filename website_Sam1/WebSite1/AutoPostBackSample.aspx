...
<body>
    ...
    <div>
        ...
        Select a semester</div>
        <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
        </asp:DropDownList>
        <br />
        <asp:CheckBox ID="CheckBox1" runat="server" Text="All" />
        <br />
        <asp:Label ID="Label2" runat="server" Text="Enter a name to search:" Visible="False"></asp:Label>
        <br />
        <asp:TextBox ID="TextBox1" runat="server" Visible="False" Width="191px"></asp:TextBox>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
