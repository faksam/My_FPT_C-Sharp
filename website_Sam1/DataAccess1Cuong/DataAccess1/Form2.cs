    ...
    public partial class Form2 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string dbst = "update StudentStatus  set SemesterId ='" + this.textBox2.Text + "',SemesterNo ='" + this.textBox3.Text + "',Status='" + this.comboBox1.SelectedItem.ToString() + "'";
                MyConnection = new SqlConnection(App.ConnectionString);
                MyConnection.Open();
                cmd = new SqlCommand(dbst, MyConnection);


                cmd.Parameters.AddWithValue("@SemesterId", textBox2.Text);
